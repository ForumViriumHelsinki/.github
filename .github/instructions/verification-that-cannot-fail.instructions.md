---
description: >-
  A check must not share the state that would make it fail — inducing outages on
  Kubernetes, and self-checks that share a key
applyTo: >-
  **/test/**,**/tests/**,**/*.test.*,**/*.spec.*,**/*_test.*,**/test_*.py,**/k8s/**,**/deploy/**
---
