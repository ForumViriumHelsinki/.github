...
# accept expressions -- so `ForumViriumHelsinki/.github/.github/actions/...@main` would
...
# carries no publish block is the issue-#115 bug returning (laurigates/.github#47
# upstream).
set -euo pipefail
